...
# uppgift 6
vi = float(input('Hur mycket väger ditt bagage i kg? '))
if vi > 8:
    print('Ditt bagage är för tungt.')
else:
    lä = float(input('Hur långt är ditt bagage i cm? '))
    if lä > 55:
        print('Ditt bagage är för långt.')
    else:
        br = float(input('Hur brett är ditt bagage i cm? '))
        if br > 40 < 55 and lä < 40:
            print('Ditt bagage är för brett, men du kan ju bara vrida på bagaget dumfan.')
            dj = float(input('Hur djupt är ditt bagage i cm? '))
            if dj > 23:
                print('Ditt bagage är för tjockt.')
            else:
                print('Ditt bagage är faller inom ramen för tillåten vikt och tillåtna dimensioner förutsatt att du lägger det ned.')
        elif br > 40:
            print('Ditt bagage är för brett.')
        else:
            dj = float(input('Hur djupt är ditt bagage i cm? '))
            if dj > 23:
                print('Ditt bagage är för tjockt.')
            else:
                print('Ditt bagage är faller inom ramen för tillåtna dimensioner och tillåten vikt.')